...
def main(target_location=None):
    ...
    def process_ard_cube(filepath):
        ...
        with h5py.File(out_path, mode) as h5_out:
            ...
            print("\nClosing HDF5 File. Awaiting final I/O chunk flush and gzip compression...")

        t_flush_end = time.perf_counter()
        print(f"HDF5 Flush & Close completed in {t_flush_end - t_flush_start:.2f} seconds.")
        ...
        if suffix in filepath and worker_cache_path and os.path.exists(worker_cache_path):
            ...
            print(f"Cleaned up throwaway worker cache in {t_clean_end - t_clean_start:.2f} seconds.")
    ...
    def process_global_timeline(h5_out, orig_filepath):
        ...
        with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_idx):
                ...
                if 'I/O_Write_&_Compress' not in agg_telemetry: 
                    agg_telemetry['I/O_Write_&_Compress'] = []
                agg_telemetry['I/O_Write_&_Compress'].append(t_write_end - t_write_start)
